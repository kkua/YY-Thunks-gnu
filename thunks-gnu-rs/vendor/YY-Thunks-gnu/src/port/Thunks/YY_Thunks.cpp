...
#define _DEFINE_IAT_SYMBOL_PREFIX(_PREFIX, _FUNCTION, _SIZE) _LCRT_DEFINE_IAT_SYMBOL(_PREFIX ## _FUNCTION, _SIZE, _CRT_CONCATENATE(YY_THUNK_FNTYPE_, _FUNCTION))
...
#define __DEFINE_THUNK_IMP_PREFIX(_PREFIX, _MODULE, _SIZE, _RETURN_, _CONVENTION_, _FUNCTION, ...)                 \
    static _CRT_CONCATENATE(YY_THUNK_FNTYPE_, _FUNCTION) __cdecl _CRT_CONCATENATE(try_get_, _FUNCTION)() noexcept       \
    {                                                                                          \
...
_CRT_CONCATENATE(YY_THUNK_RESOLVER_, _FUNCTION)                                                       \
        ...
        return reinterpret_cast<_CRT_CONCATENATE(YY_THUNK_FNTYPE_, _FUNCTION)>(try_get_function(                        \
