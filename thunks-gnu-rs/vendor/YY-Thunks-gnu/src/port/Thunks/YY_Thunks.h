...
#define _LCRT_DEFINE_IAT_SYMBOL(_FUNCTION, _SIZE, _FN_TYPE)                                                                       \
    ...
    extern "C" __declspec(selectany) void const* const __identifier(_CRT_STRINGIZE_(_imp__ ## _FUNCTION ## @ ## _SIZE)) \
        = reinterpret_cast<void const*>(static_cast<_FN_TYPE>(_FUNCTION))
#else
#define _LCRT_DEFINE_IAT_SYMBOL(_FUNCTION, _SIZE, _FN_TYPE)                                                          \
...
YY_THUNKS_ALLOCATE(".YYThu$AAA") static void* __YY_THUNKS_MODULE_START[] = { nullptr };
YY_THUNKS_ALLOCATE(".YYThu$AAB") static void* __YY_THUNKS_FUN_START[] = { nullptr }; //鸭船指针缓存开始位置
YY_THUNKS_ALLOCATE(".YYThu$AAC") static void* __YY_THUNKS_FUN_END[] = { nullptr };   //鸭船指针缓存结束位置

YY_THUNKS_ALLOCATE(".YYThr$AAA") static void* __YY_THUNKS_INIT_FUN_START[] = { nullptr }; //鸭船函数初始化开始位置
#define __YY_THUNKS_INIT_FUN_END __YY_THUNKS_UNINIT_FUN_START                               //鸭船函数初始化结束位置

YY_THUNKS_ALLOCATE(".YYThr$AAB") static void* __YY_THUNKS_UNINIT_FUN_START[] = { nullptr }; //鸭船函数反初始化函数开始
YY_THUNKS_ALLOCATE(".YYThr$AAC") static void* __YY_THUNKS_UNINIT_FUN_END[] = { nullptr };   //鸭船函数反初始化函数结束位置
...
*/
extern "C" { extern BOOL __YY_Thunks_Disable_Rreload_Dlls /* = FALSE*/; }
...
/// </returns>
extern "C" { extern HMODULE (__fastcall * const __pfnYY_Thunks_CustomLoadLibrary)(const wchar_t* _szModuleName, DWORD _fFlags); }
...
#define _APPLY(_MODULE, _NAME, _FLAGS)                                                         \
    ...
    {                                                                                          \
        YY_THUNKS_ALLOCATE(".YYThu$AAA") static volatile HMODULE hModule;                    \
...
#define _APPLY(_FUNCTION, _MODULE)                                                                    \
    ...
    {                                                                                                 \
        ...
        YY_THUNKS_ALLOCATE(".YYThr$AAA") static void* _CRT_CONCATENATE(pInit_ ,_FUNCTION) =   \
        ...
        YY_THUNKS_ALLOCATE(".YYThu$AAB") static void* _CRT_CONCATENATE( pFun_ ,_FUNCTION);          \
        static const ProcInfo _ProcInfo =                                                             \
        {                                                                                             \
            _CRT_STRINGIZE(_FUNCTION),                                                                \
            &_CRT_CONCATENATE(try_get_module_, _MODULE),                                              \
_CRT_CONCATENATE(YY_THUNK_RESOLVER_, _FUNCTION)                                                       \
        };                                                                                            \
...
// 外部weak符号，用于判断当前是否静态
extern "C" { extern void* __acrt_atexit_table; }
...
YY_THUNKS_ALLOCATE(".CRT$XID") static _PIFV ___Initialization = __YY_initialize_winapi_thunks;
YY_THUNKS_ALLOCATE(".CRT$XTY") static _PVFV ___Uninitialization = __YY_uninitialize_winapi_thunks;
